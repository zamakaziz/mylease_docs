...
(async () => {
  ...
  try {
    console.log('Logging in as Sender Test...');
    ...
    console.log('Navigating to Audit 807 with openDiscussion=1...');
    await page.goto('http://192.168.112.2:3000/auditing?tab=documents&id=807&openDiscussion=1', { waitUntil: 'networkidle' });
    await page.waitForTimeout(4000);

    console.log('Opening Mention Team Member popover inside drawer...');
    ...
    const screenshotPath = path.join(artifactDir, 'audit_807_mention_user_list.png');
